...
Alfresco SDK 4.10 extends the support to Alfresco 23.4. 
...
Alfresco SDK 4.10 provides support for Alfresco 7.0.x, 7.1.x, 7.2.x, 7.3.x, 7.4.x, 23.1.x, 23.2.x, 23.3.x and 23.4.x.
